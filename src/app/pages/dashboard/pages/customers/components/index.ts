...
export { CustomerDetailsModal } from './customer-details-modal/customer-details-modal.component';
export { CustomerStatusChart } from './customer-status-chart/customer-status-chart.component';
