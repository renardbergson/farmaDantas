...
@Component({
  selector: 'app-cashback-measure',
  imports: [],
  templateUrl: './cashback-measure.html',
  styleUrl: './cashback-measure.css',
})
export class CashbackMeasure implements OnInit, AfterViewInit, OnDestroy {
